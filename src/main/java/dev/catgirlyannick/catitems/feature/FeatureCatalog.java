...
public final class FeatureCatalog {
    private static final List<CatFeature> FEATURES = List.of(
            ...
            planned("emotes", "Player Emotes", "Player animations with sounds, particles, and held items."),
            ...
            planned("consumables", "Consumables", "Food, drink, potion, cooldown, and effect definitions."),
