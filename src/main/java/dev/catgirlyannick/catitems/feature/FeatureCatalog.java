...
public final class FeatureCatalog {
    private static final List<CatFeature> FEATURES = List.of(
            ...
            live("use-animations", "Use Animations", "YAML keyframes drive real arm poses, 3D items, particles, and sounds."),
            ...
            live("emotes", "Player Emotes", "Server-native eating, drinking, smoking, aiming, and two-handed arm-pose timelines."),
