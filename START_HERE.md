...
Current release: `0.2.1-ALPHA` for Paper 1.21 through 1.21.11 and Java 21.
...
1. Place `CatItems-0.2.1-ALPHA.jar` in `plugins/`.
...
4. Add YAML definitions under `plugins/CatItems/items/` and PNG assets under
   `plugins/CatItems/pack/assets/<namespace>/textures/item/`.
5. Run `/catitems reload` and `/catitems status`.

Ruby, sapphire, emerald gear, and a star token are included for testing.

## Documentation

- [README.md](README.md) - features and installation
- [docs/ITEM_FORMAT.md](docs/ITEM_FORMAT.md) - define custom items
